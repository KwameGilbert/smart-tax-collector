...
$taxId = intval($_GET['id']);

// Initialize variables
$errors = [];
$success = false;

// Fetch the tax type details
$query = "SELECT * FROM tax_types WHERE id = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // If no errors, update the tax type
    if (empty($errors)) {
        $query = "UPDATE tax_types SET name = ?, description = ?, amount = ?, frequency = ?, applicable_to = ? WHERE id = ?";
        $stmt = $conn->prepare($query);
        $stmt->bind_param("ssdssi", $name, $description, $amount, $frequency, $applicable_to, $taxId);
...
<head>
    ...
    <title>Edit Tax Type - Sefwi Tax Collection</title>
...
<body class="min-h-screen bg-white" id="main-body">
    <div class="md:ml-64 flex flex-col min-h-screen transition-all duration-300">
        ...
        <!-- Header -->
        <?php renderHeader('Edit Tax Type', false); ?>
        ...
        <div class="p-4 md:p-8 bg-gray-100 flex-grow overflow-y-auto">
            <div class="flex items-center mb-6">
                ...
                <h1 class="text-2xl font-bold">Edit Tax Type</h1>
            </div>
            ...
            <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-6">
                <div class="flex">
                    ...
                    <div>
                        ...
                        <p class="text-sm">The tax type has been updated successfully.</p>
