...
// No authentication needed for this landing page
?>
...
<head>
    ...
    <title>Sefwi Tax Collection System</title>
        ...
        <div class="flex justify-between items-center max-w-7xl mx-auto">
            <div class="flex items-center">
                <div class="bg-white rounded-full p-2 shadow-md">
                    <img src="assets/logo.png" alt="Sefwi Municipality Logo" class="h-12 w-12">
                </div>
                <div class="ml-4">
            ...
            <div class="hidden md:flex space-x-4">
                <a href="#" class="px-4 py-2 text-gray-600 hover:text-gray-900">About</a>
                <a href="#" class="px-4 py-2 text-gray-600 hover:text-gray-900">Contact</a>
                <a href="#" class="px-4 py-2 text-gray-600 hover:text-gray-900">Help</a>
            </div>
        </div>
    </header>
        ...
        <div class="max-w-7xl mx-auto w-full">
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Select your dashboard to manage tax collections and municipal finances efficiently.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ...
                <a href="collector/login/index.php" class="card card-collector group">
                    <div class="card-accent bg-gradient-to-r from-collector-light to-collector"></div>
                    <div class="p-8">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <span class="flex items-center text-collector font-medium text-lg enter-arrow">
                        ...
                        <p class="text-gray-600 mb-6">
                            Record tax collections, issue receipts, and manage your assigned zones and businesses.
                        </p>
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 bg-collector-light/10 text-collector rounded-full text-xs">
                ...
                <a href="finance/login/index.php" class="card card-finance group">
                    <div class="card-accent bg-gradient-to-r from-finance-light to-finance"></div>
                    <div class="p-8">
                        <div class="flex items-center justify-between mb-6">
                            <div
                            ...
                            <span class="flex items-center text-finance font-medium text-lg enter-arrow">
                                Enter <i class="ri-arrow-right-line ml-2"></i>
                            </span>
                        </div>
                        <h3
                        ...
                        <p class="text-gray-600 mb-6">
                            Monitor tax collections, generate reports, and manage financial data and operations.
                        </p>
                        <div class="flex flex-wrap gap-2">
                            <span class="px-3 py-1 bg-finance-light/10 text-finance rounded-full text-xs">
            ...
            <div class="mt-16 max-w-5xl mx-auto">
                <h3 class="text-xl font-semibold text-gray-800 mb-6 text-center">Additional Resources</h3>
    ...
    <footer class="bg-white shadow-inner py-6 px-8 mt-12">
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
            <div class="text-center md:text-left mb-4 md:mb-0">
                <p class="text-gray-600">&copy; <?php echo date('Y'); ?> Sefwi Municipal Assembly. All rights reserved.
                </p>
